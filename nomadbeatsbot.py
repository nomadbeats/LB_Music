...
OWNER_ID = int(getenv("OWNER_ID", "7422739825"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ognomadry")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/19619de416bbe7401ac2e.jpg"
)
PING_IMG_URL = getenv(
